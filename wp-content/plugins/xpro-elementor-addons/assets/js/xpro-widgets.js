        ...
        SimplePortfolio: function(t) {
            ...
            function f(i, o) {
                ...
                if ("false" !== (d = e(i).data("src-preview"))) {
                    e(i).siblings().removeClass("xpro-preview-demo-item-open"), e(i).addClass("xpro-preview-demo-item-open"), t.find(".xpro-preview .xpro-preview-prev-demo,.xpro-preview .xpro-preview-next-demo").removeClass("xpro-preview-inactive");
                    e(i).prev("[data-src-preview]").length <= 0 && t.find(".xpro-preview .xpro-preview-prev-demo").addClass("xpro-preview-inactive");
                    e(i).next("[data-src-preview]").length <= 0 && t.find(".xpro-preview .xpro-preview-next-demo").addClass("xpro-preview-inactive"), t.find(".xpro-preview .xpro-preview-header-info").html(""), n && t.find(".xpro-preview .xpro-preview-header-info").append(`<div class="xpro-preview-demo-name">${n}</div>`), t.find(".xpro-preview .xpro-preview-iframe").attr("src", d), e("body").addClass("xpro-preview-active"), t.find(".xpro-preview").addClass("active")
                }
            }
            ...
            n.on("slideChangeTransitionStart", function() {
                ...
                e(i.slides[i.activeIndex]).find("[data-animation]").each(function() {
                    ...
                    t.addClass(o).one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function() {
                        t.removeClass(o)
                    }), e(i.slides).removeClass("xpro-animation-init"), e(i.slides[i.activeIndex]).addClass("xpro-animation-init")
                })
            })
        }
    };
