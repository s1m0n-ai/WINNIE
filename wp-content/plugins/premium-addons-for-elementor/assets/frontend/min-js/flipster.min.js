! function(P, t, D) {
    ...
    P.fn.flipster = function(e) {
        ...
        var I = P.extend({}, i, e);
        return this.each(function() {
            var t, u, r, n, f, s, l, c, p, v = P(this),
                o = [],
                h = 0,
                d = !1,
                e = !1;
            ...
            function m() {
                v.css("transition", ""), u.css("transition", ""), f.css("transition", "")
            }

            function g(a) {
                var t, e;
                a && (v.css("transition", "none"), u.css("transition", "none"), f.css("transition", "none")), r = u.width(), u.height((e = 0, f.each(function() {
                    t = P(this).height(), e < t && (e = t)
                }), e)), r ? (n && (clearInterval(n), n = !1), f.each(function(t) {
                    var e, n, i = P(this);
                    i.attr("class", function(t, e) {
                        return e && e.replace(X, "").replace(j, " ")
                    }), e = i.outerWidth(), 0 !== I.spacing && i.css("margin-right", e * I.spacing + "px"), n = i.position().left, o[t] = -1 * (n + e / 2 - r / 2), t === f.length - 1 && (_(), a && setTimeout(m, 1))
            ...
            function _() {
                ...
                f.each(function(t) {
                    ...
                    }), 0 <= h && (r && o[h] !== D || g(!0), M ? u.css("transform", "translateX(" + o[h] + "px)") : u.css({
                        left: o[h] + "px"
                    })),
                    function() {
                        if (I.nav) {
                            var t = s.data("flip-category");
                            c.removeClass(T.navCurrent), p.filter(function() {
            ...
            function y(t) {
                var e = h;
                if (!(f.length <= 1)) return "prev" === t ? 0 < h ? h-- : I.loop && (h = f.length - 1) : "next" === t ? h < f.length - 1 ? h++ : I.loop && (h = 0) : "number" == typeof t ? h = t : t !== D && (h = f.index(t), I.loop && e != h && (e == f.length - 1 && h != f.length - 2 && (h = 0), 0 == e && 1 != h && (h = f.length - 1))), s = f.eq(h), h !== e && I.onItemSwitch && I.onItemSwitch.call(v, f[h], f[e]), _(), v
            }
            ...
            function k() {
                var o;
                if (u = v.find(I.itemContainer).addClass(T.container), !((f = u.find(I.itemSelector)).length <= 1)) return f.addClass(T.item).each(function() {
                    var t = P(this);
                    t.children("." + T.itemContent).length || t.wrapInner('<div class="' + T.itemContent + '" />')
                }), I.click && f.on("click.flipster touchend.flipster", function(t) {
                    e || (P(this).hasClass(T.itemCurrent) || t.preventDefault(), y(this))
                }), I.buttons && 1 < f.length && (v.find("." + T.button).remove(), v.append(i("prev"), i("next"))), o = {}, !I.nav || f.length <= 1 || (l && l.remove(), l = P('<ul class="' + T.nav + '" role="navigation" />'), p = P(""), f.each(function(t) {
                    var e = P(this),
                    ...
                    if (p = p.add(a), n) {
                        if (!o[n]) {
                            ...
                            o[n] = P('<ul class="' + T.navChild + '" />'), p = p.add(s), r.append(s, o[n]).appendTo(l)
                        }
                        o[n].append(a)
                    } else l.append(a);
            ...
            t = {
                ...
                var t;
                if (v.css("visibility", "hidden"), k(), f.length <= 1) v.css("visibility", "");
                else {
                    t = !!I.style && "flipster--" + I.style.split(" ").join(" flipster--"), v.addClass([T.main, M ? "flipster--transform" : " flipster--no-transform", t, I.click ? "flipster--click" : ""].join(" ")), I.start && (h = "center" === I.start ? Math.floor(f.length / 2) : I.start), y(h);
                    var e, n, i, a, r, s, o, l = v.find("img");
                    if (l.length) {
                        var c = 0;
                        l.on("load", function() {
                            ++c >= l.length && C()
                    ...
                    E.on("resize.flipster", L(g, 400)), I.autoplay && b(), I.pauseOnHover && u.on("mouseenter.flipster", function() {
                            d ? w(!0) : x()
                        ...
                        function(t) {
                            ...
                            "touchstart.flipster": function(t) {
                                t = t.originalEvent, n = t.touches ? t.touches[0].clientX : t.clientX, i = t.touches ? t.touches[0].clientY : t.clientY
                            },
                            "touchmove.flipster": function(t) {
                                t = t.originalEvent, a = t.touches ? t.touches[0].clientX : t.clientX, r = t.touches ? t.touches[0].clientY : t.clientY, o = a - n, s = r - i, 30 < Math.abs(o) && Math.abs(s) < 100 && t.preventDefault()
                            },
                            "touchend.flipster touchcancel.flipster ": function() {
                                o = a - n, s = r - i, 30 < Math.abs(o) && Math.abs(s) < 100 && y(0 < o ? "prev" : "next")
                            }
                        })
                }
            }()
